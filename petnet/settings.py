...
# Sets debug to True if the environment variable DEVELOPMENT exists
# Deployed environment won't have it so will set to False
...
ACCOUNT_FORMS = {'signup': 'petnet.forms.MyCustomSignupForm'}
